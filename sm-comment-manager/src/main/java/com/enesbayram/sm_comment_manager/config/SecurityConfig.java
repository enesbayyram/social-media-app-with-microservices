package com.enesbayram.sm_comment_manager.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(
                        request ->
                                request.requestMatchers(GlobalConstant.AUTHENTICATE, GlobalConstant.REGISTER, GlobalConstant.REFRESH_TOKEN , "/ws/**").permitAll()
